...
public final class ToUnicodeWriter{
	 ...
	 */
	public void setWMode(int wMode){this.wMode = wMode;}
	...
	public void add(int cid, String text){
		if (cid < 0 || cid > 0xFFFF){ throw new IllegalArgumentException("CID is not valid");}
	...
	public void writeTo(OutputStream out) throws IOException{
		...
		if (wMode != 0){writeLine(writer, "/WMode /" + wMode + " def");}
